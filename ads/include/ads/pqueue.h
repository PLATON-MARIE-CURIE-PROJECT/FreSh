...
// EKOSMAS: forward declaration
typedef struct MESSI_workerdata_ekosmas_lf MESSI_workerdata_ekosmas_lf;
...
void *pqueue_pop_lf(pqueue_t *q, MESSI_workerdata_ekosmas_lf *input_data);
...
// EKOSMAS: 23/08/2022 - HEAPSORT - START
void heap_sort(pqueue_t *q, int n);
// EKOSMAS: 23/08/2022 - HEAPSORT - END
